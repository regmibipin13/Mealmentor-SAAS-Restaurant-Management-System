...
class ItemsController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('restaurants.items.index', compact('items', 'itemCategories', 'units'));
    }
    ...
    public function create()
    {
        ...
        $itemCategories = ItemCategory::pluck('name', 'id');
        $units = Unit::pluck('name', 'id');
        return view('restaurants.items.create', compact('itemCategories', 'units'));
    }
    ...
    public function edit(Item $item)
    {
        ...
        $itemCategories = ItemCategory::pluck('name', 'id');
        $units = Unit::pluck('name', 'id');
        return view('restaurants.items.edit', compact('item', 'itemCategories', 'units'));
    }
