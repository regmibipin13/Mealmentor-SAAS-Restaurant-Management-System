                            ...
                            <tr v-for="order, key in pendingOrders">
                                ...
                                <td>
                                    <a class="btn btn-sm btn-primary" style="background: #0a58ca;"
                                        :href="'/admin/pos-orders/' + order.id">View</a>
                                    &nbsp;&nbsp;
...
export default {
    name: 'pos',
    props: ['categories', 'tables', 'restaurant_id'],
    data: function () {
        return {
            search: {
                name: '',
    ...
    methods: {
        ...
        submitOrder() {
            ...
            this.cart.restaurant_id = this.restaurant_id
        ...
        markComplete(index) {
            if (index >= 0) {
                axios.patch('/admin/pos-orders/' + this.pendingOrders[index].id, {
